import{d,i as _,a as p,u,b as h,c as m,e as f,f as n,g as t,t as a,h as o,F as g,r as v,n as x,j as b,o as r,k as y,l as k,m as w,p as N,q as P,_ as S}from"./index-61672cff.js";import{N as V}from"./NoteDisplay-a7355179.js";const j={class:"m-4"},L={class:"mb-10"},T={class:"text-4xl font-bold mt-2"},B={class:"opacity-50"},C={class:"text-lg"},D={class:"font-bold flex gap-2"},H={class:"opacity-50"},z=t("div",{class:"flex-auto"},null,-1),F={key:0,class:"border-gray-400/50 mb-8"},M=d({__name:"PresenterPrint",setup(q){_(p),u(`
@page {
  size: A4;
  margin-top: 1.5cm;
  margin-bottom: 1cm;
